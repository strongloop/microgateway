...
module.exports = function populateMessageVariables(options) {
  ...
  /**
   * Set message.body with a copy of the request.body.
   * Changing message.body should not change request.body content
   *
   * @param {Context} ctx the APIm context object
   * @param body is the body to be clone/set to message.body
   */
