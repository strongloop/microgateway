...
function initialize(oauthModels, options) {
  ...
  var token = {};
  token.find = function(apiId, accessToken, done) {
  ...
  token.delete = function(apiId, clientId, token, tokenType, done) {
  ...
  token.save = function(apiId, token, clientId, resourceOwner, scopes, 
      refreshToken, expire, secret, done) {
