...
var apiMatcher = require('./middleware/api-matcher-2');
...
var DataStore = require('../datastore2/server');
...
var DataStore = require('../datastore2/server');
var DataStoreClient = require('../datastore2/client/local-client');
...
app.locals.dataStoreClient = new DataStoreClient(dataStore);
