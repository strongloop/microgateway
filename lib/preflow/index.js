    ...
    contextget(ctx, contextgetOptions, function(error, apis) {
      ...
      populateAPImCtx(api, ctx, req)
        .then(function(output) {
            // this is insufficient as we might not have an OPTIONS request defined
            // in Swagger, so we wouldn't even get here (needless to mention we are)
            // missing all of the other CORS headers
